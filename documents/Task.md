...
Симулятор написан на Node.js, поэтому для запуска вам нужен либо Docker, либо установленный Node.js. Симулятор расположен в каталоге `gate-simulator`. Для запуска необходимо перейти в этот каталог. 
